      ...
      return (
          <div className="">
                ...
                <div className="flex items-center gap-8 sticky top-0 backdrop-blur-md p-4 z-10 bg-[#00000084]">
                      ...
                      <h1 className="font-bold text-lg">Adwaith jayan</h1>
                </div>
                {/* INFO */}
                <div className="">
                      ...
                      <div className="relative w-full">
                            ...
                            {/* AVATAR */}
                            <div
                                className="w-1/5 aspect-square rounded-full overflow-hidden border-4 border-black bg-gray-300 absolute left-4 -translate-y-1/2">
                      ...
                      <div className="p-4 flex flex-col gap-2">
                            {/* USERNAME & HANDLE */}
                            <div className="">
                                  <h1 className="text-2xl font-bold">Adwaith jayan</h1>
                                  <span className="text-textGray text-sm">@adwaithjayan</span>
                            </div>
                            <p>Adwaith jayan Youtube Channel</p>
                            {/* JOB & LOCATION & DATE */}
